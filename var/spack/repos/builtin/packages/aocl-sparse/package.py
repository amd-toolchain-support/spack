...
class AoclSparse(CMakePackage):
    ...
    version('3.0',  sha256='9c280a4be164b6ea257b4575ec3c55f154d4dc5a8d2d929a73eb683173bcc95c')
    version('2.2',  sha256='33c2ed6622cda61d2613ee63ff12c116a6cd209c62e54307b8fde986cd65f664')

    def url_for_version(self, version):
        if version == Version('3.0'):
            return "http://aocl.amd.com/data/spack/aocl-sparse/3.0.tar.gz"
        else:
            return "https://github.com/amd/aocl-sparse/archive/2.2.tar.gz"
